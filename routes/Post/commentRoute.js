...
commentRoute.post('/:postId/comment', async (req, res) => {
    ...
    try {
        ...
        const comment = await Comment.findById(saveComment._id).populate('user', '_id name  profile_pic', User)
...
commentRoute.get('/:postId/comment', async (req, res) => {
    ...
    try {
        const comments = await Comment.find({ post: req.params.postId })
            ...
            .limit(limit)
            .skip(page * limit)
            .populate('user', '_id name profile_pic', User)
...
commentRoute.get('/:commentId/like_dislike', async (req, res) => {
